...
`esito-risposta-payprint.md`, che dice che cosa ha chiuso la loro risposta scritta dell'11 settembre
...
la risposta ha fatto emergere tre difetti da correggere (vedi `esito-risposta-payprint.md`).
...
mail è compresso. PayPrint ha risposto l'11 settembre (`risposta-payprint-2026-09-11.md`): sotto
ogni domanda c'è lo stato dopo la risposta, come risulta da `esito-risposta-payprint.md`.
...
dispositivo, e il lavoro da fare è lì (`esito-risposta-payprint.md`, paragrafo 3). Resta da
...
> rispettare: ogni invio che non sia `AN` o `CM` va bloccato lì (`esito-risposta-payprint.md`,
> paragrafo 3).
...
in ordine di peso è in `esito-risposta-payprint.md`, paragrafo 5. In testa: quanti messaggi
...
| che cosa c'è già in Giano | *Giano: dove siamo* (documento 4), e per il dettaglio riga per riga `analisi-giano-vne-vs-pagamico.md` |
| il testo delle domande per PayPrint | `mail-payprint-domande-protocollo.md` |
| la risposta di PayPrint, e che cosa ha chiuso | `risposta-payprint-2026-09-11.md` e `esito-risposta-payprint.md` |
