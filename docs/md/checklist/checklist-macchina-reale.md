...
(`md/memoria-claude/esito-risposta-payprint.md`, capitolo 3 punti 11-13 e capitolo 5). Ogni prova dice **cosa fare**,
**cosa guardare** e **cosa decide**.

> **Su quale macchina.** Questo elenco è scritto per una macchina **nostra**. Sulla macchina di
> PayPrint vale `md/guide/guida-prove-macchina-payprint.md`, che ha la stessa numerazione ma regole più
...
> `md/verbali/prove-banchi-ramo1-2026-09-16.md` mostra le righe che il banco scrive quando tutto funziona.
>
...
> Su una macchina **non nostra** (quella di PayPrint) valgono regole più strette, gruppo per gruppo: `md/guide/guida-prove-macchina-payprint.md`, capitolo 3.
...
> **Solo sulla nostra macchina.** Il gruppo `immagini` contiene `SF`, che **sostituisce il logo permanente**. Su una macchina altrui (PayPrint) fare la prova dal banco con `[SI]`/`[SR]` e la stampa, con il consenso: vedi `md/guide/guida-prove-macchina-payprint.md`.
...
- [ ] Riportare gli esiti in `md/memoria-claude/esito-risposta-payprint.md` (tabella del capitolo 1 e punti 11-13)
