...
*11 settembre 2026. La risposta originale sta in `md/fornitore/risposta-payprint-2026-09-11.md`, le domande in
`md/fornitore/mail-payprint-domande-protocollo.md`. Ogni affermazione qui sotto è stata verificata sul codice
...
> `md/verbali/prove-banchi-ramo1-2026-09-16.md`. In particolare si è vista dal vivo la forma dei **due frame
...
> di `md/checklist/checklist-macchina-reale.md`. Il timeout di 5 minuti resta finché quella prova non conferma.
...
> difetto non si riproduce. Dettagli in `md/verbali/prova-terminatore-cr-2026-09-14.md`.
