...
righe identiche: `md/verbali/prove-banchi-ramo1-2026-09-16.md`.
...
anche con i tre difetti emersi dalla risposta di PayPrint (D1-D3 in `md/memoria-claude/esito-risposta-payprint.md`).
...
1. **Comandi accorpati.** Prova a spezzare il segmento usando una tabella di trenta comandi a
   ...
   (domande 1.1 e 1.2, vedi `md/memoria-claude/esito-risposta-payprint.md`): a quel punto anche due comandi nello
   stesso segmento dovrebbero passare. Sul simulatore è provato dal 14 settembre, e passa anche
   senza terminatore (`md/verbali/prova-terminatore-cr-2026-09-14.md`); sulla macchina va ancora provato. Il
...
- **Il keepalive con un cavo staccato.** I test verificano i valori applicati al socket, non dopo
  quanto una caduta vera viene vista: è la prova 10 di `md/checklist/checklist-macchina-reale.md`.
...
(domanda 2.4 in `md/memoria-claude/esito-risposta-payprint.md`). L'attesa che usa, fino al 10 settembre, la
...
(domanda 2.2 in `md/memoria-claude/esito-risposta-payprint.md`). È la differenza fra *«smetto di ascoltare»* e *«annullo davvero»*, ed è il
