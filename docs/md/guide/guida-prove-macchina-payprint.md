...
> **In breve.** Le prove da fare sono le 11 di `md/checklist/checklist-macchina-reale.md`. Questa guida dice come farle sulla macchina di PayPrint: che cosa chiedere prima, come collegarsi, quali programmi usare, e soprattutto **quali parti del collaudo automatico non vanno lanciate** su una macchina che non è nostra. Servono quattro cose: un collegamento alla macchina, una persona di PayPrint davanti alla macchina, qualche moneta e banconota, e il nostro banco di prova con il log acceso.
...
|---|---|---|---|
| 1 | `pdf/memoria-claude/esito-risposta-payprint.pdf` | che cosa ha già detto il fornitore, i tre difetti trovati, e nel **capitolo 5 le 11 domande da fargli a voce** | 15 min |
| 2 | `pdf/checklist/checklist-macchina-reale.pdf` | le 11 prove in forma di elenco: cosa fare, cosa guardare, cosa decide ciascuna | 10 min |
...
| 4 | `pdf/verbali/prove-banchi-ramo1-2026-09-16.pdf` | com'è fatto un log giusto: le stesse prove già eseguite sul simulatore, riga per riga | 10 min |

`md/memoria-claude/decisioni-innesto-giano.md` non serve durante la sessione, ma dice **perché** le prove 4, 5 e 9
...
Numerazione di `md/checklist/checklist-macchina-reale.md`. Prima di ogni prova dire alla persona di PayPrint che cosa sta per succedere.
...
> **Le prove 4 e 5 decidono la Decisione 1 di Giano** (`md/memoria-claude/decisioni-innesto-giano.md`): che cosa significa "annulla senza restituire". Annotare con cura importi e comportamento fisico.
...
- Riportare gli esiti in `md/memoria-claude/esito-risposta-payprint.md` (capitolo 1 e punti 11-13) e in `md/memoria-claude/decisioni-innesto-giano.md`.
