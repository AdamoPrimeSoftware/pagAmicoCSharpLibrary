...
- **Il comando che chiude un incasso trattenendo il parziale risponde due volte**, almeno sul
  ...
  riceveva trattenuto 0,00 (difetto D1 in `md/memoria-claude/esito-risposta-payprint.md`). Ora chiude sul messaggio
...
> (`md/verbali/prova-terminatore-cr-2026-09-14.md`). Gli 80 ms, **misura empirica sul simulatore** e non
> minimo garantito dal firmware, restano come rete di sicurezza finché la raffica con CR non regge
> su una macchina vera: l'ordine di lavoro è in `md/memoria-claude/esito-risposta-payprint.md`.
...
- **Non c'è riconnessione automatica.** Alla caduta, in entrambe le librerie, **tutte le attese in
  ...
  prerequisito per togliere il timeout dell'incasso (`md/memoria-claude/esito-risposta-payprint.md`, D2), ed è
...
- **L'esito di un rifiuto dice se sono entrati soldi.** Un incasso rifiutato prima dell'`OK` lancia
  ...
  qualsiasi chiudeva l'attesa dell'incasso (difetto D3 in `md/memoria-claude/esito-risposta-payprint.md`). Sui
...
- **Il timeout di transazione è cinque minuti, e per l'incasso il fornitore dice di non metterlo**:
  ...
  libreria non lo sa e non lo compensa (difetto D2 in `md/memoria-claude/esito-risposta-payprint.md`). Toglierlo non
...
(`md/fornitore/mail-payprint-domande-protocollo.md`). Nel primo messaggio ne partono però solo due — la
...
(`md/verbali/prova-terminatore-cr-2026-09-14.md`). Le due che riguardano
